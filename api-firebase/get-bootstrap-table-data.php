...
if (isset($_GET['table']) && $_GET['table'] == 'panchangam_new') {
    ...
    $sql = "SELECT COUNT(`id`) as total FROM `panchangam_new`";
    $db->sql($sql);
    $res = $db->getResult();
    foreach ($res as $row)
        $total = $row['total'];
   
    $sql = "SELECT * FROM panchangam_new " . $where . " ORDER BY " . $sort . " " . $order . " LIMIT " . $offset . ", " . $limit;
    $db->sql($sql);
    $res = $db->getResult();
    ...
    foreach ($res as $row) {
        ...
        $operate = ' <a href="edit-panchangam_new.php?id=' . $row['id'] . '"><i class="fa fa-edit"></i>Edit</a>';
        $operate .= ' <a class="text text-danger" href="delete-panchangam_new.php?id=' . $row['id'] . '"><i class="fa fa-trash"></i>Delete</a>';
        $tempRow['id'] = $row['id'];
        $tempRow['date'] = $row['date'];
        $tempRow['sunrise'] = date('h:i a', strtotime($row['sunrise']));
        $tempRow['sunset'] = date('h:i a', strtotime($row['sunset']));
...
//Grahanalu table goes here
if (isset($_GET['table']) && $_GET['table'] == 'grahanalu') {
    $offset = 0;
    $limit = 10;
    $where = '';
    $sort = 'id';
    ...
    $sql = "SELECT COUNT(`id`) as total FROM `grahanalu_tab` ";
    $db->sql($sql);
    $res = $db->getResult();
    foreach ($res as $row)
        $total = $row['total'];
   
    $sql = "SELECT * FROM grahanalu_tab " . $where . " ORDER BY " . $sort . " " . $order . " LIMIT " . $offset . ", " . $limit;
    $db->sql($sql);
    $res = $db->getResult();
    ...
    $row_number = $row_start;
    foreach ($res as $row) {
        $operate = '<a href="edit-grahanalu.php?id=' . $row['id'] . '" class="label label-primary" title="Edit">Edit</a>';
        $operate .= ' <a class="text text-danger" href="delete-grahanalu.php?id=' . $row['id'] . '"><i class="fa fa-trash"></i>Delete</a>';
        $tempRow['id'] = $row_number++;
        $tempRow['year'] = $row['year'];
        $tempRow['title'] = $row['title'];
        $tempRow['description'] = $row['description'];
...
if (isset($_GET['table']) && $_GET['table'] == 'navagrahalu') {
    ...
    $sql = "SELECT COUNT(`id`) as total FROM `navagrahalu_tab` ";
    $db->sql($sql);
    $res = $db->getResult();
    foreach ($res as $row)
        $total = $row['total'];
   
    $sql = "SELECT * FROM navagrahalu_tab " . $where . " ORDER BY " . $sort . " " . $order . " LIMIT " . $offset . ", " . $limit;
    $db->sql($sql);
    $res = $db->getResult();
    ...
    $row_number = $row_start;
    foreach ($res as $row) {
        $operate = '<a href="edit-navagrahalu.php?id=' . $row['id'] . '" class="label label-primary" title="Edit">Edit</a>';
...
//Navarathnalu table goes here
if (isset($_GET['table']) && $_GET['table'] == 'navarathnalu') {
    $offset = 0;
    $limit = 10;
    $where = '';
    $sort = 'id';
    ...
    $sql = "SELECT COUNT(`id`) as total FROM `navarathnalu_tab` ";
    $db->sql($sql);
    $res = $db->getResult();
    foreach ($res as $row)
        $total = $row['total'];
   
    $sql = "SELECT * FROM navarathnalu_tab " . $where . " ORDER BY " . $sort . " " . $order . " LIMIT " . $offset . ", " . $limit;
    $db->sql($sql);
    $res = $db->getResult();
    ...
    $row_number = $row_start;
    foreach ($res as $row) {
        $operate = '<a href="edit-navarathnalu.php?id=' . $row['id'] . '" class="label label-primary" title="Edit">Edit</a>';
        $operate .= ' <a class="text text-danger" href="delete-navarathnalu.php?id=' . $row['id'] . '"><i class="fa fa-trash"></i>Delete</a>';
        $tempRow['id'] = $row_number++;
        $tempRow['title'] = $row['title'];
        $tempRow['description'] = $row['description'];
        $tempRow['operate'] = $operate;
...
//Rudhraksha table goes here
if (isset($_GET['table']) && $_GET['table'] == 'rudhraksha') {
    $offset = 0;
    $limit = 10;
    $where = '';
    $sort = 'id';
    ...
    $sql = "SELECT COUNT(`id`) as total FROM `rudhraksha_tab` ";
    $db->sql($sql);
    $res = $db->getResult();
    foreach ($res as $row)
        $total = $row['total'];
   
    $sql = "SELECT * FROM rudhraksha_tab " . $where . " ORDER BY " . $sort . " " . $order . " LIMIT " . $offset . ", " . $limit;
    $db->sql($sql);
    $res = $db->getResult();
    ...
    $row_number = $row_start;
    foreach ($res as $row) {
        $operate = '<a href="edit-rudhraksha.php?id=' . $row['id'] . '" class="label label-primary" title="Edit">Edit</a>';
        $operate .= ' <a class="text text-danger" href="delete-rudhraksha.php?id=' . $row['id'] . '"><i class="fa fa-trash"></i>Delete</a>';
        $tempRow['id'] = $row_number++;
        $tempRow['title'] = $row['title'];
        $tempRow['description'] = $row['description'];
        $tempRow['operate'] = $operate;
...
if (isset($_GET['table']) && $_GET['table'] == 'alivelu_manga') {
    $offset = 0;
    $limit = 10;
    $where = '';
    $sort = 'id';
    ...
    $sql = "SELECT COUNT(`id`) as total FROM `alivelu_manga` ";
    $db->sql($sql);
    $res = $db->getResult();
    foreach ($res as $row)
        $total = $row['total'];
   
    $sql = "SELECT * FROM alivelu_manga " . $where . " ORDER BY " . $sort . " " . $order . " LIMIT " . $offset . ", " . $limit;
    $db->sql($sql);
    $res = $db->getResult();
    ...
    $row_number = $row_start;
    foreach ($res as $row) {
        $operate = '<a href="edit-alivelu_manga.php?id=' . $row['id'] . '" class="label label-primary" title="Edit">Edit</a>';
        $operate .= ' <a class="text text-danger" href="delete-alivelu_manga.php?id=' . $row['id'] . '"><i class="fa fa-trash"></i>Delete</a>';
        $tempRow['id'] = $row_number++;
        $tempRow['title'] = $row['title'];
        $tempRow['description'] = $row['description'];
        $tempRow['operate'] = $operate;
...
if (isset($_GET['table']) && $_GET['table'] == 'govinda_namalu') {
    $offset = 0;
    $limit = 10;
    $where = '';
    $sort = 'id';
    ...
    $sql = "SELECT COUNT(`id`) as total FROM `govinda_namalu` ";
    $db->sql($sql);
    $res = $db->getResult();
    foreach ($res as $row)
        $total = $row['total'];
   
    $sql = "SELECT * FROM govinda_namalu " . $where . " ORDER BY " . $sort . " " . $order . " LIMIT " . $offset . ", " . $limit;
    $db->sql($sql);
    $res = $db->getResult();
    ...
    $row_number = $row_start;
    foreach ($res as $row) {
        $operate = '<a href="edit-govinda_namalu.php?id=' . $row['id'] . '" class="label label-primary" title="Edit">Edit</a>';
        $operate .= ' <a class="text text-danger" href="delete-govinda_namalu.php?id=' . $row['id'] . '"><i class="fa fa-trash"></i>Delete</a>';
        $tempRow['id'] = $row_number++;
        $tempRow['title'] = $row['title'];
        $tempRow['description'] = $row['description'];
        $tempRow['operate'] = $operate;
...
if (isset($_GET['table']) && $_GET['table'] == 'pushkaralu') {
    ...
    $sql = "SELECT COUNT(`id`) as total FROM `pushkaralu` ";
    $db->sql($sql);
    $res = $db->getResult();
    foreach ($res as $row)
        $total = $row['total'];
   
    $sql = "SELECT * FROM pushkaralu " . $where . " ORDER BY " . $sort . " " . $order . " LIMIT " . $offset . ", " . $limit;
    $db->sql($sql);
    $res = $db->getResult();
    ...
    foreach ($res as $row) {
        $operate = ' <a href="edit-pushkaralu.php?id=' . $row['id'] . '"><i class="fa fa-edit"></i>Edit</a>';
        $operate .= ' <a class="text text-danger" href="delete-pushkaralu.php?id=' . $row['id'] . '"><i class="fa fa-trash"></i>Delete</a>';
        $tempRow['id'] = $row['id'];
        $tempRow['title'] = $row['title'];
        $tempRow['description'] = $row['description'];
        $tempRow['operate'] = $operate;
...
if (isset($_GET['table']) && $_GET['table'] == 'vasthu_tips') {
    ...
    $sql = "SELECT COUNT(`id`) as total FROM `vasthu_tips` ";
    $db->sql($sql);
    $res = $db->getResult();
    foreach ($res as $row)
        $total = $row['total'];
   
    $sql = "SELECT * FROM vasthu_tips " . $where . " ORDER BY " . $sort . " " . $order . " LIMIT " . $offset . ", " . $limit;
    $db->sql($sql);
    $res = $db->getResult();
    ...
    foreach ($res as $row) {
        $operate = ' <a href="edit-vasthu_tips.php?id=' . $row['id'] . '"><i class="fa fa-edit"></i>Edit</a>';
        $operate .= ' <a class="text text-danger" href="delete-vasthu_tips.php?id=' . $row['id'] . '"><i class="fa fa-trash"></i>Delete</a>';
        $tempRow['id'] = $row['id'];
        $tempRow['title'] = $row['title'];
        $tempRow['description'] = $row['description'];
        $tempRow['operate'] = $operate;
